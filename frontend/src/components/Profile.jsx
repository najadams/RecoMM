        ...
        <div className="chart-bars">
          {readingData.weeklyReading.map((hours, index) => (
            <div key={index} className="chart-day">
              <div
                className="chart-bar"
                style={{ height: `${(hours / (maxHours || 1)) * 100}%` }}></div>
        ...
        <div className="profile-container">
            ...
            <div className="profile-content">
              <div className="profile-left">
                ...
                <div className="profile-details">
                  ...
                  <p>
                    <strong>BIRTHDAY:</strong> MM/DD/YYYY
                  </p>
                  <p>
                    <strong>FAV GENRE</strong>
                  </p>
                  <p>ACTION, HORROR, COMEDY</p>
                  <p>
                    <strong>JOINED IN MM/DD/YYYY</strong>
                  </p>
                </div>
              </div>
          ...
          <div className="reading-stats">
            ...
            <div className="stats-container">
              <div className="weekly-stats">{renderWeeklyChart()}</div>
              <div className="streak-stats">
                <div className="streak-icon">🔥</div>
                <div className="streak-info">
                  <span className="streak-number">
                    {readingData.dailyStreak}
                  </span>
